...
require (
	github.com/Netcracker/qubership-logging-operator v0.0.0-20250124090229-8028b3970db4
	github.com/Netcracker/qubership-logging-operator/api v0.0.0-20250124090229-8028b3970db4
